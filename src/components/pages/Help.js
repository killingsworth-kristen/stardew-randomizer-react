        ...
        <main>
            ...
            <section className="faq">
                <div className="page-center">
                    <div>
                        <h4 className="help-question"><b>Q: How is my information stored?</b></h4>
                        <p className="help-para">Your data is stored only in your browser and is not sent to a server or anything else. You are in full control of your data.</p>
                    </div>
                    <div>
                        <h4 className="help-question"><b>Q: How do I import my file from google sheets?</b></h4>
